...
unsigned char AnalyzeBuff[2048];
...
void SPI_Configuration(void)
{
	...
	SPI_InitTypeDef   	SPI_InitStructure;	   
  	...
  	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOA| RCC_APB2Periph_SPI1 | RCC_APB2Periph_AFIO, ENABLE);	
...
IntDispose:
	...
	if(Read_W5500_1Byte(SIR)&0x01 != 0) 
		goto IntDispose;
}
